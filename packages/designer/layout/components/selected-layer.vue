<template>
  <div ref="el" class="selected-layer" absolute inset-0 pointer-events-none z-9>
    ...
    <div v-if="designerCtx.activeId" absolute outline="1.5 solid [--el-color-primary]" outline-offset--1.5 :style="calcStyle(activeEl())">
      <div class="actions absolute bottom-[100%] flex text-15 pointer-events-auto c-white bg-[--el-color-primary]">  
