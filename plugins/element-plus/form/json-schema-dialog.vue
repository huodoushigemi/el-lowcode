<template>
  <div mb18 divide="x-1 solid current">
...
// todo
const jsonSchema = computed(() => JSON.stringify(designerCtx.widgets['ElForm-c'].JSONSchemaOutput(designerCtx.active.data, designerCtx), null, '  '))
